/**
 * Action schemas - Zod schemas for all available actions
 */
...
export const searchGoogleActionSchema: ActionSchema = {
  name: 'search_google',
  description: 'Search the query in Google',
  schema: z.object({
...
export const scrollToPercentActionSchema: ActionSchema = {
  ...
  description: 'Scrolls to a particular vertical percentage of the document or an element',
  schema: z.object({
    intent: z.string().default('').describe('purpose of this action'),
    yPercent: z.number().int().describe('percentage to scroll to - min 0, max 100'),
...
export const scrollToTopActionSchema: ActionSchema = {
  name: 'scroll_to_top',
  description: 'Scroll the document or an element to the top',
  schema: z.object({
    intent: z.string().default('').describe('purpose of this action'),
    index: z.number().int().nullable().optional().describe('index of the element'),
  }),
...
export const scrollToBottomActionSchema: ActionSchema = {
  ...
  description: 'Scroll the document or an element to the bottom',
  schema: z.object({
    intent: z.string().default('').describe('purpose of this action'),
    index: z.number().int().nullable().optional().describe('index of the element'),
  }),
...
export const previousPageActionSchema: ActionSchema = {
  name: 'previous_page',
  description: 'Scroll the document or an element to the previous page',
  schema: z.object({
    intent: z.string().default('').describe('purpose of this action'),
    index: z.number().int().nullable().optional().describe('index of the element'),
  }),
...
export const nextPageActionSchema: ActionSchema = {
  name: 'next_page',
  description: 'Scroll the document or an element to the next page',
  schema: z.object({
    intent: z.string().default('').describe('purpose of this action'),
    index: z.number().int().nullable().optional().describe('index of the element'),
  }),
...
export const sendKeysActionSchema: ActionSchema = {
  name: 'send_keys',
  description: 'Send keyboard keys like Enter, Backspace, or shortcuts like Control+c',
  schema: z.object({
    intent: z.string().default('').describe('purpose of this action'),
...
export const selectDropdownOptionActionSchema: ActionSchema = {
  ...
  description: 'Select dropdown option by the text of the option',
  schema: z.object({
    intent: z.string().default('').describe('purpose of this action'),
    index: z.number().int().describe('index of the dropdown element'),
